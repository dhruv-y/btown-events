$(document).ready(function () {
    // make the request
    if ($("#MainContent_locationlbl")[0].textContent != "")
        displayMap();

});
function displayMap() {
    var apikey = 'de49c04ce22f4ce4814a84134077ad3d';
    var address = $("#MainContent_locationlbl")[0].textContent + ",Bloomington, Indiana";
    var location = $("#MainContent_venueNamelbl")[0].textContent;
