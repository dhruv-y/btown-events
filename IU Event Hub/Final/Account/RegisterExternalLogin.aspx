<%@ Page Title="Register External Login" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="RegisterExternalLogin.aspx.cs" Inherits="Account_RegisterExternalLogin" Async="true" %>
    ...
    <asp:PlaceHolder runat="server">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <asp:Label ID="test" runat="server" Text="NOTHING"></asp:Label>
                <div class="col-md-10">
